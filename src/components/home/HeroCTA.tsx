      ...
      <div className="flex gap-2">
        {onGenerateQR && (
          <motion.button
            ...
            className="flex items-center justify-center gap-2.5 flex-1 rounded-2xl border border-dashed border-border bg-surface-alt px-4 py-3 min-h-[44px] text-text-secondary hover:bg-surface hover:border-primary/40 hover:text-primary active:scale-[0.98] transition-all"
        ...
        <motion.button
          ...
          className="flex items-center justify-center gap-2 rounded-2xl border border-dashed border-border bg-surface-alt px-4 py-3 min-h-[44px] text-text-secondary hover:bg-surface hover:border-primary/40 hover:text-primary active:scale-[0.98] transition-all"
          whileTap={{ scale: 0.98, transition: { duration: 0.1 } }}
        >
          {linkCopied ? (
