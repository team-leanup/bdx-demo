...
const PUBLIC_ROUTES = ['/', '/splash', '/intro', '/login', '/signup', '/signup/google', '/intro-demo', '/terms', '/privacy', '/auth/callback', '/qr', '/guide'];
const PUBLIC_PREFIXES = ['/onboarding', '/pre-consult', '/share', '/_next', '/api', '/auth'];
